  ...
  theme: {
    extend: {
      ...
      spacing: {
        ...
        "card-meta-h": "var(--wege-card-meta-h)",
        "card-name-h": "var(--wege-card-name-h)",
        "card-swatch-h": "var(--wege-card-swatch-h)",
        "card-color-h": "var(--wege-card-color-h)",
      ...
      width: {
        ...
        "icon-close": "var(--wege-size-icon-close)",
